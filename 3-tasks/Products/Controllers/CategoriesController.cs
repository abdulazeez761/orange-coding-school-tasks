...
namespace Products.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var viewModel = (Category: category, Products: (IEnumerable<Products.Models.Product>)categoryProducts);

            return View(viewModel);
        }

        public async Task<IActionResult> SearchPage(int id, string productName)
        {
            Categories Category = await _context.Categories.FindAsync(id);
            if (Category is null) return NotFound();

            List<Product> filteredProducts = await _context.Products
        .Where(product => product.ProductCategoryID == id && product.ProductName.Contains(productName))
        .ToListAsync();
            ...
            // Prepare the view model with both the category and the filtered products
            var viewModel = (Category: Category, Products: (IEnumerable<Products.Models.Product>)filteredProducts);
